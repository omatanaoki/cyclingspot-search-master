    ...
    @if (count($cycles) > 0)
        <table class="table table-striped">
            @foreach ($cycles as $cycle)
                <div id="alert_card{{$cycle->id}}" class="col-sm-4 alert_card">
                    <div class="card" style="border:solid; border-width:thin; margin-bottom:10px">
                                ...
                                @if(Auth::id() == $cycle->user_id)
                                    ...
                                    <ul class="dropdown-menu" style="list-style: none;">
                                        <li class="dropdown-item">
                                            <a href="{{ route('cycles.edit', [$cycle->id]) }}"><span class="fa fa-edit" style="color:black;"></span></a>
                        ...
                        <a href="cycles/{{$cycle->id}}"><img src="{{$cycle->image}}" style="width:100%; max-height:200px;"></a>
                        <div class="card-footer" style="border-top:solid; border-width:thin;">
                            <div class="title" style="font-size:1.3em;　text-align:left;">{{$cycle->title}}</div>
                            <div class="side">
...
<link rel="stylesheet" href="{{asset('/css/cycles_posts.css')}}">