...
@section('content')
    ...
    {!! Form::model($cycle, ['route' => 'cycles.store', 'files' => true, 'onsubmit' => "return false;"]) !!}
        <div class="side">
        ...
        <p class="submit">{!! Form::button('投稿', ['class' => 'btn btn-primary submit_button', 'onclick' => 'submit();']) !!}</p>
    {!! Form::close() !!}

<script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
<script src="{{ asset('/js/cycle_create.js') }}"></script>
<script src="{{ asset('/js/city.js') }}"></script>
<script src="{{ asset('/js/submit_disable.js') }}"></script>
<script src="{{ asset('/js/file_upload.js') }}"></script>
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyACynbQFfINh_-6Yi-iRfaFAOrzU9ks6rY"></script>
@endsection
<link rel="stylesheet" href="{{asset('/css/cycles_create_edit.css')}}">