<ul class="nav nav-tabs nav-justified mb-3 col-12">
    <li class="nav-item"><a href="{{ route('users.show', [$user->id]) }}" class="nav-link {{ Request::is('users/' . $user->id) ? 'active' : '' }}">タイムライン <span class="badge badge-secondary">{{ $count_cycles }}</span></a></li>
